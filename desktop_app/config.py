...
TALLY_SERIAL_NUMBER = os.getenv("TALLY_SERIAL_NUMBER", "")
...
INVOICEAI_LICENSE_FILE = os.getenv("INVOICEAI_LICENSE_FILE", str(RUNTIME_DIR / "invoiceai_license.json"))
ERPNEXT_PURCHASE_ACCOUNT = os.getenv("ERPNEXT_PURCHASE_ACCOUNT", PURCHASE_LEDGER_NAME)
ERPNEXT_CGST_ACCOUNT = os.getenv("ERPNEXT_CGST_ACCOUNT", INPUT_CGST_LEDGER_NAME)
ERPNEXT_SGST_ACCOUNT = os.getenv("ERPNEXT_SGST_ACCOUNT", INPUT_SGST_LEDGER_NAME)
ERPNEXT_IGST_ACCOUNT = os.getenv("ERPNEXT_IGST_ACCOUNT", INPUT_IGST_LEDGER_NAME)
ERPNEXT_CESS_ACCOUNT = os.getenv("ERPNEXT_CESS_ACCOUNT", INPUT_CESS_LEDGER_NAME)
